...
INSERT INTO branchs(branch_id, manager_id, branch_address, contact_no) 
VALUES
...
SELECT issued_emp_id, COUNT (*) AS count_of_issued_books
FROM issued_status
...
FROM employee AS e1
JOIN branchs b ON b.branch_id = e1.branch_id
...
SELECT m.member_id, m.member_name, ist.issued_book_name, ist.issued_date, DATEDIFF(DAY, ist.issued_date, GETDATE()) AS overdue_days
	FROM 
	members as m
...
SELECT
	...
	COUNT(rs.return_id) AS number_of_books_rtd,
...
GROUP BY e.emp_name, e.emp_id, b.branch_id, b.manager_id
